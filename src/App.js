  ...
  return (
    <div className="App">
      <div className="container1">
        <div id="frontpage">
          <a href="#aboutsd" className="frontlink rightline" id="softwaredev">Software Development</a>
          <a href="#aboutavi" className="frontlink leftline"  id="aviation">Aircraft Maintenance </a>
        </div>
      </div>
      <NavbarSD />
      <AboutSD />
