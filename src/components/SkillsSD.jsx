...
export default function SkillsSD() {
  return (
    <section id="skillsd">
      ...
      <p className="grayf">
        I am familiar with a host of languages and technologies focusing on
        front end development, I continue to explore and learn new areas of
        software development daily to grow my knowledge.
      </p>
